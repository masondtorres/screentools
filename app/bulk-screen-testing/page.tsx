  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-8">
      ...
      <section className="content-prose mt-6">
        ...
        <p>If your team wants to share a real workflow, contact us and describe the devices you test, the volume, and the checks you repeat most often.</p>
      </section>
      <Link href="mailto:hello@example.com?subject=ScreenTools%20bulk%20screen%20testing" className="mt-6 inline-block rounded bg-ink px-5 py-3 font-bold text-white">Contact us for early access</Link>
    </main>
  );
}
